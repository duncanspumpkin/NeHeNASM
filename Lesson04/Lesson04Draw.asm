...
DrawGLScene:
  ...
  fld dword [rotationTriangle]
  fadd dword [rotT]
  fstp dword [rotationTriangle]

  fld dword [rotationSquare]
  fsub dword [rotS]
  fstp dword [rotationSquare]

  mov dword eax,1
ret ;DrawGLScene
section .bss use32
rotationTriangle resd 1
rotationSquare   resd 1
